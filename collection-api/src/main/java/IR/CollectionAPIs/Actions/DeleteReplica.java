...
/**
 * {@link SolrAction} this is a class that expose a delete replica to collection API
 *
 * @see SolrAction
 */
public class DeleteReplica implements SolrAction {
    ...
    public DeleteReplica(CloudSolrClient solrClient) {
        this.solrClient = solrClient;
    }

    public DeleteReplica setCollectionName(String collectionName) {
        this.collectionName = collectionName;
        return this;
    }

    public DeleteReplica setShard(String shard) {
        this.shard = shard;
        return this;
    }

    public DeleteReplica setReplica(String node) {
        this.replica = node;
        return this;
    }
    ...
    public SolrResponse execute() throws IOException, SolrServerException, RuntimeException {
        var solrAdminCommand = CollectionAdminRequest.deleteReplica(collectionName, shard, replica);
        logger.info("created delete replica request");
